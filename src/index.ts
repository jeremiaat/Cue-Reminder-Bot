...
// Polling can throw (e.g. transient Telegram 409 if another instance is
// polling). Retry instead of letting the process die.
...
init()
  .then(async () => {
    ...
    // any leftover webhook so long-polling always wins cleanly.
    try {
